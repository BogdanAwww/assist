...
import {ComposeOutputTypeDefinition, ObjectTypeComposerArgumentConfigDefinition} from 'graphql-compose';

export interface FieldConfig<TArgs extends Record<string, any> = Record<string, any>, TContext = any, TSource = any> {
